...
# (optional) check if topic are created
bin/kafka-topics.sh --list topics --zookeeper localhost:2181

# (optional) describe each of the topic
bin/kafka-topics.sh --describe topic streams-plaintext-input --zookeeper localhost:2181
bin/kafka-topics.sh --describe topic streams-wordcount-output --zookeeper localhost:2181

# start a kafka producer
bin/kafka-console-producer.sh --broker-list localhost:9092 --topic streams-plaintext-input
# after a shell will be opened enter
kafka streams udemy
...
# - DefaultMessageFormatter: both keys and values will be printed
